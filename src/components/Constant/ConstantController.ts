...
export const getAllConstant = (req, res) => {
    return res.status(HTTP_OK).send(new ResponseSuccess({
        ...
        result: { whoInFamily, diseases, typeOfTermination, typeOfAbortion, vaginal, cesareanSection, liveBirthsDescription, genderOfChild, pregnancyType, assisted, donor, flow, natureOfCycle }
    }))
}