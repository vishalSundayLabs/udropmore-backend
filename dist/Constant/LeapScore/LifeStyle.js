            ...
            },
            {
                ...
                question: [{
                        ...
                        subQuestions: [{
                                ...
                                option: {
                                    A: { header: "Meat", options: [{ name: Food_1.food.meatPork.name, isSelected: false }, { name: Food_1.food.beef.name, isSelected: false }, { name: Food_1.food.lamp.name, isSelected: false }], score: 1 },
                                    B: { header: "Birds", options: [{ name: Food_1.food.birdsChicken.name, isSelected: false }, { name: "Turkey", isSelected: false }], score: 1 },
                                    C: { header: "Fish", options: [{ name: Food_1.food.fishSalmon.name, isSelected: false }, { name: Food_1.food.rawas.name, isSelected: false }, { name: Food_1.food.bombayDuck.name, isSelected: false }], score: 1 },
