...
router.post("/weekly/content/upload/files/:week", tokenVerify_1.verifyToken, createPath_1.preprocessMiddlewareForCreatingPath, AwsFileUploader_1.upload.array("file"), CMSController_1.uploadImagesAndVideo);
